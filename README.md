<div align="center">
  ...
  <p><strong>A private, secure, and modern Android music app with ad-free streaming, synced lyrics, offline playback, and an intuitive user experience.
</strong></p>
</div>
...
Zyra delivers a seamless, premium listening experience by leveraging YouTube Music's vast library — without the ads. It adds powerful extras including offline downloads, real-time synchronized lyrics, and environment-aware music recognition.
...
Zyra stands on the shoulders of several excellent open-source projects. Sincere thanks to:
...
| [Music Recognizer](https://github.com/aleksey-saenko/MusicRecognizer) | Audio recognition (Zyra Find) |
| [Flow](https://github.com/a-edev/Flow) | AI queue generation engine (Zyra Brain) |
