...
import zyra.echo.music.constants.MaxSongCacheSizeKey
import zyra.echo.music.db.InternalDatabase
import zyra.echo.music.db.MusicDatabase
import zyra.echo.music.listentogether.ListenTogetherClient
...
object AppModule {
    ...
    fun provideInternalDatabase(
        ...
        .addMigrations(
            zyra.echo.music.db.MIGRATION_1_2,
            zyra.echo.music.db.MIGRATION_21_24,
            zyra.echo.music.db.MIGRATION_22_24,
            zyra.echo.music.db.MIGRATION_24_25,
            zyra.echo.music.db.MIGRATION_27_28,
            zyra.echo.music.db.MIGRATION_36_37,
            zyra.echo.music.db.MIGRATION_37_38,
            zyra.echo.music.db.MIGRATION_38_39,
        )
