...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "zyra.echo.music.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "zyra.echo.music.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "zyra.echo.music.widget.playlists.UPDATE_WIDGET"
