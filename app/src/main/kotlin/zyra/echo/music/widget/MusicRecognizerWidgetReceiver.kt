...
package zyra.echo.music.widget
...
import zyra.echo.music.recognition.MusicRecognitionService
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import zyra.echo.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "zyra.echo.music.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "zyra.echo.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "zyra.echo.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "zyra.echo.music.widget.recognizer.RESET"
    }
}
