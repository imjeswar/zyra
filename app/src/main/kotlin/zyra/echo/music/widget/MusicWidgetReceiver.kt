...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "zyra.echo.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "zyra.echo.music.widget.LIKE"
        const val ACTION_NEXT = "zyra.echo.music.widget.NEXT"
        const val ACTION_PREVIOUS = "zyra.echo.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "zyra.echo.music.widget.UPDATE_WIDGET"
    }
}
