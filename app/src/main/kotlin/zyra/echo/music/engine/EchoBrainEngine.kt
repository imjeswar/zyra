package zyra.echo.music.engine

import androidx.media3.common.MediaItem
import androidx.media3.common.Player
import zyra.echo.music.data.EchoBrainRepository
...
import zyra.echo.music.db.DatabaseDao
import zyra.echo.music.engine.brain.FlowNeuroEngine
import zyra.echo.music.engine.brain.InteractionType
...
class EchoBrainEngine @Inject constructor(
    ...
    private fun fetchAndInjectSuggestions(trackId: String) {
        ...
        if (!conn.service.currentQueue.supportsDynamicRecommendations) {
            return
        }
