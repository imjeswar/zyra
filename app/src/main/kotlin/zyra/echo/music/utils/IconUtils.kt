...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "zyra.echo.music.MainActivityAlias")
        val static = ComponentName(context, "zyra.echo.music.MainActivityStatic")
        val legacy = ComponentName(context, "zyra.echo.music.MainActivityLegacy")
