...
import zyra.echo.music.utils.BotDetectionMitigator
...
import zyra.echo.music.utils.YTPlayerUtils.MAIN_CLIENT
import zyra.echo.music.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import zyra.echo.music.utils.YTPlayerUtils.validateStatus
import zyra.echo.music.utils.potoken.PoTokenGenerator
import zyra.echo.music.utils.potoken.PoTokenResult
import zyra.echo.music.utils.sabr.EjsNTransformSolver
import zyra.echo.music.utils.PlaybackLogLevel
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        val showFallbackToast = context?.let { 
            it.dataStore.data.first()[zyra.echo.music.constants.ShowAudioFallbackToastKey] 
        } ?: true
...
fun confidence(queryArtist: String, queryTitle: String, queryDuration: Long?, candidate: zyra.echo.music.utils.qobuz.QobuzTrack): Float {
