...
import zyra.echo.music.engine.EchoBrainEngine
import zyra.echo.music.engine.brain.*
...
fun EchoBrainScreen(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.echo_brain_enable)),
                                        ...
                                        onCheckedChange = { isChecked ->
                                            ...
                                            coroutineScope.launch {
                                                context.dataStore.edit { prefs ->
                                                    prefs[zyra.echo.music.constants.EchoBrainEnabledKey] = isChecked
                                                }
                                            }
                                        }
                                    )
                                ...
                                onClick = { 
                                    ...
                                    scope.launch {
                                        context.dataStore.edit { prefs ->
                                            prefs[zyra.echo.music.constants.EchoBrainEnabledKey] = !isEnabled
                                        }
                                    }
                                }
                            )
