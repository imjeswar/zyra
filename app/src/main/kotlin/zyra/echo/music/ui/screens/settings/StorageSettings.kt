...
import zyra.echo.music.constants.MaxImageCacheSizeKey
...
import zyra.echo.music.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    zyra.echo.music.playback.ExoDownloadService::class.java,
                    false
                )
